...
## 🙋‍♂️ About Me:
- 🔭 I'm currently working as a **Full Stack Developer 💻 | Mobile Application Developer 📱 | Flutter Engineer 🚀**
- 🎓 Fresh Graduate — Computer Science & IT, Zagazig University (GPA: 3.84 ⭐)
- 🌱 I'm currently learning **Advanced Flutter & Clean Architecture**
- 🤖 Passionate about **AI Integration** in mobile apps (TensorFlow Lite, Gemini, ChatGPT)
- 👨‍💻 All of my projects are available at **[My Repository](https://github.com/OmarAliSiad?tab=repositories)**
- 📫 Reach me at **omaraliabdelaziz250@gmail.com**
...
|--------|-------------|------------|
| 🍔 **EasyFast** | Food ordering app with real-time tracking & payments | Flutter, Firebase, Google Maps |
| 🚗 **Delivery EasyFast** | Driver management app with live location & localization | Flutter, Firebase Auth |
| 🏫 **Smart School System** | IoT-integrated school management (Graduation Project) | Flutter, Dart, Firebase, IoT |
| 🏢 **WebFab** | Cross-platform project marketplace (dual-interface) | Flutter, REST APIs |
...
<h3 align="center">
    <img src="https://readme-typing-svg.herokuapp.com/?font=Righteous&size=25&center=true&vCenter=true&width=500&height=70&duration=4000&lines=Thanks+for+visiting!+❤️;Full+Stack+%7C+Mobile+%7C+AI+Integration;Long+Life+Learner+🚀" />
</h3>
